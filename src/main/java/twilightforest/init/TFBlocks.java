...
public class TFBlocks {
	public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(BuiltInRegistries.BLOCK, TwilightForestMod.ID);

	public static final RegistryObject<TFPortalBlock> TWILIGHT_PORTAL = BLOCKS.register("twilight_portal", () -> new TFPortalBlock(BlockBehaviour.Properties.of().strength(-1.0F).sound(SoundType.GLASS).lightLevel((state) -> 11).noCollission().noOcclusion().noLootTable()));

	//misc.
	public static final RegistryObject<Block> HEDGE = BLOCKS.register("hedge", () -> new HedgeBlock(BlockBehaviour.Properties.of().strength(2.0F, 6.0F).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> FIREFLY_JAR = BLOCKS.register("firefly_jar", () -> new JarBlock(BlockBehaviour.Properties.of().strength(0.3F, 3.0F).sound(SoundType.BONE_BLOCK).lightLevel((state) -> 15).noOcclusion()));
	public static final RegistryObject<Block> FIREFLY_SPAWNER = BLOCKS.register("firefly_particle_spawner", () -> new FireflySpawnerBlock(BlockBehaviour.Properties.of().strength(0.3F, 3.0F).sound(SoundType.BONE_BLOCK).lightLevel((state) -> 15).noOcclusion()));
	public static final RegistryObject<Block> CICADA_JAR = BLOCKS.register("cicada_jar", () -> new JarBlock(BlockBehaviour.Properties.of().strength(0.3F, 3.0F).sound(SoundType.BONE_BLOCK).noOcclusion().randomTicks()));
	public static final RegistryObject<Block> MOSS_PATCH = BLOCKS.register("moss_patch", () -> new MossPatchBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.MOSS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> MAYAPPLE = BLOCKS.register("mayapple", () -> new MayappleBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> CLOVER_PATCH = BLOCKS.register("clover_patch", () -> new PatchBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> FIDDLEHEAD = BLOCKS.register("fiddlehead", () -> new FiddleheadBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> MUSHGLOOM = BLOCKS.register("mushgloom", () -> new MushgloomBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.FUNGUS).noCollission().noOcclusion().lightLevel((state) -> 3)));
	public static final RegistryObject<Block> TORCHBERRY_PLANT = BLOCKS.register("torchberry_plant", () -> new TorchberryPlantBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.HANGING_ROOTS).noCollission().noOcclusion().lightLevel((state) -> (state.getValue(TorchberryPlantBlock.HAS_BERRIES) ? 8 : 0))));
	public static final RegistryObject<Block> ROOT_STRAND = BLOCKS.register("root_strand", () -> new RootStrandBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.HANGING_ROOTS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> FALLEN_LEAVES = BLOCKS.register("fallen_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.AZALEA_LEAVES).noCollission().noOcclusion()));
	public static final RegistryObject<Block> ROOT_BLOCK = BLOCKS.register("root", () -> new Block(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> LIVEROOT_BLOCK = BLOCKS.register("liveroot_block", () -> new LiverootBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> UNCRAFTING_TABLE = BLOCKS.register("uncrafting_table", UncraftingTableBlock::new);
	public static final RegistryObject<Block> SMOKER = BLOCKS.register("smoker", () -> new TFSmokerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).strength(1.5F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> ENCASED_SMOKER = BLOCKS.register("encased_smoker", () -> new EncasedSmokerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> FIRE_JET = BLOCKS.register("fire_jet", () -> new FireJetBlock(BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).strength(1.5F, 6.0F).sound(SoundType.WOOD).randomTicks().lightLevel((state) -> state.getValue(FireJetBlock.STATE) != FireJetVariant.FLAME ? 0 : 15)));
	public static final RegistryObject<Block> ENCASED_FIRE_JET = BLOCKS.register("encased_fire_jet", () -> new EncasedFireJetBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> 15)));
	public static final RegistryObject<Block> FIREFLY = BLOCKS.register("firefly", () -> new FireflyBlock(BlockBehaviour.Properties.of(new Material.Builder(MapColor.GRASS).noCollider().nonSolid().build()).lightLevel((state) -> 15).sound(SoundType.SLIME_BLOCK).instabreak().noCollission()));
	public static final RegistryObject<Block> CICADA = BLOCKS.register("cicada", () -> new CicadaBlock(BlockBehaviour.Properties.of(new Material.Builder(MapColor.GRASS).noCollider().nonSolid().build()).sound(SoundType.SLIME_BLOCK).instabreak().noCollission()));
	public static final RegistryObject<Block> MOONWORM = BLOCKS.register("moonworm", () -> new MoonwormBlock(BlockBehaviour.Properties.of(new Material.Builder(MapColor.GRASS).noCollider().nonSolid().build()).lightLevel((state) -> 14).sound(SoundType.SLIME_BLOCK).instabreak().noCollission()));
	public static final RegistryObject<HugeLilyPadBlock> HUGE_LILY_PAD = BLOCKS.register("huge_lily_pad", () -> new HugeLilyPadBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS)));
	public static final RegistryObject<Block> HUGE_WATER_LILY = BLOCKS.register("huge_water_lily", () -> new HugeWaterLilyBlock(BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));
	public static final RegistryObject<RotatedPillarBlock> SLIDER = BLOCKS.register("slider", SliderBlock::new);
	public static final RegistryObject<Block> IRON_LADDER = BLOCKS.register("iron_ladder", () -> new IronLadderBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL).noOcclusion()));

	//naga courtyard
	public static final RegistryObject<Block> NAGASTONE_HEAD = BLOCKS.register("nagastone_head", () -> new TFHorizontalBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> NAGASTONE = BLOCKS.register("nagastone", () -> new NagastoneBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> SPIRAL_BRICKS = BLOCKS.register("spiral_bricks", SpiralBrickBlock::new);
	public static final RegistryObject<Block> ETCHED_NAGASTONE = BLOCKS.register("etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> MOSSY_ETCHED_NAGASTONE = BLOCKS.register("mossy_etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> CRACKED_ETCHED_NAGASTONE = BLOCKS.register("cracked_etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	...
	//lich tower
	public static final RegistryObject<RotatedPillarBlock> TWISTED_STONE = BLOCKS.register("twisted_stone", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	...
	public static final RegistryObject<RotatedPillarBlock> BOLD_STONE_PILLAR = BLOCKS.register("bold_stone_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final RegistryObject<Block> DEATH_TOME_SPAWNER = BLOCKS.register("death_tome_spawner", () -> new TomeSpawnerBlock(BlockBehaviour.Properties.of().strength(2.5F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> EMPTY_CANOPY_BOOKSHELF = BLOCKS.register("empty_canopy_bookshelf", () -> new Block(BlockBehaviour.Properties.of().strength(1.5F).sound(SoundType.WOOD)));
	...
	//labyrinth
	public static final RegistryObject<Block> MAZESTONE = BLOCKS.register("mazestone", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(100.0F, 5.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> RED_THREAD = BLOCKS.register("red_thread", () -> new RedThreadBlock(BlockBehaviour.Properties.of().instabreak().noCollission().color(MapColor.FIRE)));

	//stronghold
	public static final RegistryObject<Block> STRONGHOLD_SHIELD = BLOCKS.register("stronghold_shield", () -> new StrongholdShieldBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(-1.0F, 6000000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> TROPHY_PEDESTAL = BLOCKS.register("trophy_pedestal", () -> new TrophyPedestalBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(2.0F, 2000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> UNDERBRICK = BLOCKS.register("underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> MOSSY_UNDERBRICK = BLOCKS.register("mossy_underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CRACKED_UNDERBRICK = BLOCKS.register("cracked_underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> UNDERBRICK_FLOOR = BLOCKS.register("underbrick_floor", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));

	//dark tower
	public static final RegistryObject<Block> TOWERWOOD = BLOCKS.register("towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> ENCASED_TOWERWOOD = BLOCKS.register("encased_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> CRACKED_TOWERWOOD = BLOCKS.register("cracked_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> MOSSY_TOWERWOOD = BLOCKS.register("mossy_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> INFESTED_TOWERWOOD = BLOCKS.register("infested_towerwood", () -> new InfestedTowerwoodBlock(1, 0, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(1.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> REAPPEARING_BLOCK = BLOCKS.register("reappearing_block", () -> new ReappearingBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> 4)));
	// FIXME Split Vanishing block into regular breakable variant, and then the unbreakable variant
	public static final RegistryObject<Block> VANISHING_BLOCK = BLOCKS.register("vanishing_block", () -> new VanishingBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(-1.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(VanishingBlock.ACTIVE) ? 4 : 0)));
	public static final RegistryObject<Block> LOCKED_VANISHING_BLOCK = BLOCKS.register("locked_vanishing_block", () -> new LockedVanishingBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(-1.0F, 2000.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> CARMINITE_BUILDER = BLOCKS.register("carminite_builder", () -> new BuilderBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(BuilderBlock.STATE) == TowerDeviceVariant.BUILDER_ACTIVE ? 4 : 0)));
	public static final RegistryObject<Block> BUILT_BLOCK = BLOCKS.register("built_block", () -> new TranslucentBuiltBlock(BlockBehaviour.Properties.of().strength(50.0F, 2000.0F).sound(SoundType.METAL).noOcclusion().noLootTable()));
	public static final RegistryObject<Block> ANTIBUILDER = BLOCKS.register("antibuilder", () -> new AntibuilderBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> 10)));
	public static final RegistryObject<Block> ANTIBUILT_BLOCK = BLOCKS.register("antibuilt_block", () -> new Block(BlockBehaviour.Properties.of().strength(0.3F, 2000.0F).sound(SoundType.METAL).noLootTable().noOcclusion()));
	public static final RegistryObject<GhastTrapBlock> GHAST_TRAP = BLOCKS.register("ghast_trap", () -> new GhastTrapBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(GhastTrapBlock.ACTIVE) ? 15 : 0)));
	...
	public static final RegistryObject<Block> REACTOR_DEBRIS = BLOCKS.register("reactor_debris", () -> new Block(BlockBehaviour.Properties.of().strength(0.3F, 2000.0F).sound(SoundType.METAL).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> FAKE_GOLD = BLOCKS.register("fake_gold", () -> new Block(BlockBehaviour.Properties.of().strength(50.0F, 2000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> FAKE_DIAMOND = BLOCKS.register("fake_diamond", () -> new Block(BlockBehaviour.Properties.of().strength(50.0F, 2000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> EXPERIMENT_115 = BLOCKS.register("experiment_115", Experiment115Block::new);

	//aurora palace
	public static final RegistryObject<Block> AURORA_BLOCK = BLOCKS.register("aurora_block", () -> new AuroraBrickBlock(BlockBehaviour.Properties.of().strength(10.0F, 6.0F)));
	public static final RegistryObject<RotatedPillarBlock> AURORA_PILLAR = BLOCKS.register("aurora_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
	public static final RegistryObject<Block> AURORA_SLAB = BLOCKS.register("aurora_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
	...
	public static final RegistryObject<Block> BROWN_THORNS = BLOCKS.register("brown_thorns", () -> new ThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noLootTable()));
	public static final RegistryObject<Block> GREEN_THORNS = BLOCKS.register("green_thorns", () -> new ThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noLootTable()));
	public static final RegistryObject<Block> BURNT_THORNS = BLOCKS.register("burnt_thorns", () -> new BurntThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.01F, 0.0F).sound(SoundType.SAND).noLootTable()));
	public static final RegistryObject<Block> THORN_ROSE = BLOCKS.register("thorn_rose", () -> new ThornRoseBlock(BlockBehaviour.Properties.of().strength(10.0F, 0.0F).sound(SoundType.GRASS).noCollission()));
	public static final RegistryObject<Block> THORN_LEAVES = BLOCKS.register("thorn_leaves", () -> new ThornLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> BEANSTALK_LEAVES = BLOCKS.register("beanstalk_leaves", () -> new BeanstalkLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> DEADROCK = BLOCKS.register("deadrock", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CRACKED_DEADROCK = BLOCKS.register("cracked_deadrock", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> WEATHERED_DEADROCK = BLOCKS.register("weathered_deadrock", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> TROLLSTEINN = BLOCKS.register("trollsteinn", () -> new TrollsteinnBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(2.0F, 6.0F).sound(SoundType.STONE).randomTicks()));
	public static final RegistryObject<Block> WISPY_CLOUD = BLOCKS.register("wispy_cloud", () -> new HalfTransparentBlock(BlockBehaviour.Properties.of().strength(0.3F, 0.0F).sound(SoundType.WOOL).noOcclusion()));
	public static final RegistryObject<Block> FLUFFY_CLOUD = BLOCKS.register("fluffy_cloud", () -> new Block(BlockBehaviour.Properties.of().strength(0.8F, 0.0F).sound(SoundType.WOOL)));
	...
	public static final RegistryObject<Block> UBEROUS_SOIL = BLOCKS.register("uberous_soil", () -> new UberousSoilBlock(BlockBehaviour.Properties.of().strength(0.6F).sound(SoundType.GRAVEL)));
	public static final RegistryObject<RotatedPillarBlock> HUGE_STALK = BLOCKS.register("huge_stalk", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(1.5F, 3.0F).sound(SoundType.STEM)));
	...
	public static final RegistryObject<Block> HUGE_MUSHGLOOM = BLOCKS.register("huge_mushgloom", () -> new HugeMushroomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final RegistryObject<Block> HUGE_MUSHGLOOM_STEM = BLOCKS.register("huge_mushgloom_stem", () -> new HugeMushroomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final RegistryObject<Block> TROLLVIDR = BLOCKS.register("trollvidr", () -> new TrollRootBlock(BlockBehaviour.Properties.of().sound(SoundType.AZALEA_LEAVES).instabreak().noCollission()));
	public static final RegistryObject<Block> UNRIPE_TROLLBER = BLOCKS.register("unripe_trollber", () -> new UnripeTorchClusterBlock(BlockBehaviour.Properties.of().sound(SoundType.AZALEA_LEAVES).instabreak().noCollission().randomTicks()));
	public static final RegistryObject<Block> TROLLBER = BLOCKS.register("trollber", () -> new TrollRootBlock(BlockBehaviour.Properties.of().sound(SoundType.FLOWERING_AZALEA).instabreak().noCollission().lightLevel((state) -> 15)));

	//plateau castle
	public static final RegistryObject<Block> CASTLE_BRICK = BLOCKS.register("castle_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> CASTLE_ROOF_TILE = BLOCKS.register("castle_roof_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> ENCASED_CASTLE_BRICK_PILLAR = BLOCKS.register("encased_castle_brick_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> ENCASED_CASTLE_BRICK_TILE = BLOCKS.register("encased_castle_brick_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BOLD_CASTLE_BRICK_PILLAR = BLOCKS.register("bold_castle_brick_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BOLD_CASTLE_BRICK_TILE = BLOCKS.register("bold_castle_brick_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> PINK_CASTLE_RUNE_BRICK = BLOCKS.register("pink_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BLUE_CASTLE_RUNE_BRICK = BLOCKS.register("blue_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> YELLOW_CASTLE_RUNE_BRICK = BLOCKS.register("yellow_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> VIOLET_CASTLE_RUNE_BRICK = BLOCKS.register("violet_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> VIOLET_FORCE_FIELD = BLOCKS.register("violet_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> PINK_FORCE_FIELD = BLOCKS.register("pink_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> ORANGE_FORCE_FIELD = BLOCKS.register("orange_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> GREEN_FORCE_FIELD = BLOCKS.register("green_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> BLUE_FORCE_FIELD = BLOCKS.register("blue_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> CINDER_FURNACE = BLOCKS.register("cinder_furnace", CinderFurnaceBlock::new);
	public static final RegistryObject<RotatedPillarBlock> CINDER_LOG = BLOCKS.register("cinder_log", () -> new TFLogBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(1.0F)));
	public static final RegistryObject<Block> CINDER_WOOD = BLOCKS.register("cinder_wood", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(1.0F)));
	public static final RegistryObject<Block> YELLOW_CASTLE_DOOR = BLOCKS.register("yellow_castle_door", () -> new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MapColor.NONE : MapColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 100.0F)));
	public static final RegistryObject<Block> VIOLET_CASTLE_DOOR = BLOCKS.register("violet_castle_door", () -> new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MapColor.NONE : MapColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 100.0F)));
	public static final RegistryObject<Block> PINK_CASTLE_DOOR = BLOCKS.register("pink_castle_door", () -> new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MapColor.NONE : MapColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 100.0F)));
	public static final RegistryObject<Block> BLUE_CASTLE_DOOR = BLOCKS.register("blue_castle_door", () -> new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MapColor.NONE : MapColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 100.0F)));

	//mini structures
	public static final RegistryObject<Block> TWILIGHT_PORTAL_MINIATURE_STRUCTURE = BLOCKS.register("twilight_portal_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> HEDGE_MAZE_MINIATURE_STRUCTURE = BLOCKS.register("hedge_maze_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> HOLLOW_HILL_MINIATURE_STRUCTURE = BLOCKS.register("hollow_hill_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> QUEST_GROVE_MINIATURE_STRUCTURE = BLOCKS.register("quest_grove_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> MUSHROOM_TOWER_MINIATURE_STRUCTURE = BLOCKS.register("mushroom_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> NAGA_COURTYARD_MINIATURE_STRUCTURE = BLOCKS.register("naga_courtyard_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> LICH_TOWER_MINIATURE_STRUCTURE = BLOCKS.register("lich_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> MINOTAUR_LABYRINTH_MINIATURE_STRUCTURE = BLOCKS.register("minotaur_labyrinth_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> HYDRA_LAIR_MINIATURE_STRUCTURE = BLOCKS.register("hydra_lair_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> GOBLIN_STRONGHOLD_MINIATURE_STRUCTURE = BLOCKS.register("goblin_stronghold_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> DARK_TOWER_MINIATURE_STRUCTURE = BLOCKS.register("dark_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> YETI_CAVE_MINIATURE_STRUCTURE = BLOCKS.register("yeti_cave_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> AURORA_PALACE_MINIATURE_STRUCTURE = BLOCKS.register("aurora_palace_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> TROLL_CAVE_COTTAGE_MINIATURE_STRUCTURE = BLOCKS.register("troll_cave_cottage_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> FINAL_CASTLE_MINIATURE_STRUCTURE = BLOCKS.register("final_castle_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> KNIGHTMETAL_BLOCK = BLOCKS.register("knightmetal_block", () -> new KnightmetalBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(5.0F, 40.0F).sound(SoundType.NETHERITE_BLOCK)));
	public static final RegistryObject<Block> IRONWOOD_BLOCK = BLOCKS.register("ironwood_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(5.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> FIERY_BLOCK = BLOCKS.register("fiery_block", () -> new FieryBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BLACK).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL).noOcclusion().emissiveRendering((state, world, pos) -> true)));
	public static final RegistryObject<Block> STEELEAF_BLOCK = BLOCKS.register("steeleaf_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(5.0F, 6.0F).sound(SoundType.MOSS)));
	public static final RegistryObject<Block> ARCTIC_FUR_BLOCK = BLOCKS.register("arctic_fur_block", () -> new ArcticFurBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOL).strength(0.8F).sound(SoundType.WOOL)));
	public static final RegistryObject<Block> CARMINITE_BLOCK = BLOCKS.register("carminite_block", () -> new CarminiteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).instabreak().sound(SoundType.SLIME_BLOCK)));

	//boss trophies and spawners
	public static final RegistryObject<Block> NAGA_BOSS_SPAWNER = BLOCKS.register("naga_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.NAGA));
	public static final RegistryObject<Block> LICH_BOSS_SPAWNER = BLOCKS.register("lich_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.LICH));
	public static final RegistryObject<Block> HYDRA_BOSS_SPAWNER = BLOCKS.register("hydra_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.HYDRA));
	public static final RegistryObject<Block> UR_GHAST_BOSS_SPAWNER = BLOCKS.register("ur_ghast_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.UR_GHAST));
	public static final RegistryObject<Block> KNIGHT_PHANTOM_BOSS_SPAWNER = BLOCKS.register("knight_phantom_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.KNIGHT_PHANTOM));
	public static final RegistryObject<Block> SNOW_QUEEN_BOSS_SPAWNER = BLOCKS.register("snow_queen_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.SNOW_QUEEN));
	public static final RegistryObject<Block> MINOSHROOM_BOSS_SPAWNER = BLOCKS.register("minoshroom_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.MINOSHROOM));
	public static final RegistryObject<Block> ALPHA_YETI_BOSS_SPAWNER = BLOCKS.register("alpha_yeti_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.ALPHA_YETI));
	public static final RegistryObject<Block> FINAL_BOSS_BOSS_SPAWNER = BLOCKS.register("final_boss_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.FINAL_BOSS));
	...
	public static final RegistryObject<HollowLogVertical> HOLLOW_VANGROVE_LOG_VERTICAL = BLOCKS.register("hollow_vangrove_log_vertical", () -> new HollowLogVertical(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).strength(2.0F).sound(SoundType.WOOD), TFBlocks.HOLLOW_VANGROVE_LOG_CLIMBABLE));
	...
	public static final RegistryObject<HollowLogClimbable> HOLLOW_VANGROVE_LOG_CLIMBABLE = BLOCKS.register("hollow_vangrove_log_climbable", () -> new HollowLogClimbable(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).strength(2.0F).sound(SoundType.WOOD), TFBlocks.HOLLOW_VANGROVE_LOG_VERTICAL));
	...
	public static final RegistryObject<Block> MANGROVE_ROOT = BLOCKS.register("mangrove_root", () -> new Block(BlockBehaviour.Properties.of().strength(2.0F).sound(SoundType.WOOD)));

	public static final RegistryObject<Block> TWILIGHT_OAK_LEAVES = BLOCKS.register("twilight_oak_leaves", () -> new TFLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> CANOPY_LEAVES = BLOCKS.register("canopy_leaves", () -> new TFLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> MANGROVE_LEAVES = BLOCKS.register("mangrove_leaves", () -> new TFLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> DARK_LEAVES = BLOCKS.register("dark_leaves", () -> new DarkLeavesBlock(BlockBehaviour.Properties.of().strength(2.0F, 10.0F).sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> HARDENED_DARK_LEAVES = BLOCKS.register("hardened_dark_leaves", () -> new HardenedDarkLeavesBlock(BlockBehaviour.Properties.of().strength(2.0F, 10.0F).sound(SoundType.AZALEA_LEAVES)));
	public static final RegistryObject<Block> RAINBOW_OAK_LEAVES = BLOCKS.register("rainbow_oak_leaves", () -> new TFLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> TIME_LEAVES = BLOCKS.register("time_leaves", () -> new MagicLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).sound(SoundType.AZALEA_LEAVES).randomTicks().noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> TRANSFORMATION_LEAVES = BLOCKS.register("transformation_leaves", () -> new MagicLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).sound(SoundType.AZALEA_LEAVES).randomTicks().noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> MINING_LEAVES = BLOCKS.register("mining_leaves", () -> new MagicLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).sound(SoundType.AZALEA_LEAVES).randomTicks().noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> SORTING_LEAVES = BLOCKS.register("sorting_leaves", () -> new MagicLeavesBlock(BlockBehaviour.Properties.of().strength(0.2F).sound(SoundType.AZALEA_LEAVES).randomTicks().noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));

	public static final RegistryObject<SaplingBlock> TWILIGHT_OAK_SAPLING = BLOCKS.register("twilight_oak_sapling", () -> new SaplingBlock(new SmallOakTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> CANOPY_SAPLING = BLOCKS.register("canopy_sapling", () -> new SaplingBlock(new CanopyTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> MANGROVE_SAPLING = BLOCKS.register("mangrove_sapling", () -> new MangroveSaplingBlock(new MangroveTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> DARKWOOD_SAPLING = BLOCKS.register("darkwood_sapling", () -> new SaplingBlock(new DarkCanopyTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> HOLLOW_OAK_SAPLING = BLOCKS.register("hollow_oak_sapling", () -> new SaplingBlock(new HollowTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> TIME_SAPLING = BLOCKS.register("time_sapling", () -> new SaplingBlock(new TimeTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> TRANSFORMATION_SAPLING = BLOCKS.register("transformation_sapling", () -> new SaplingBlock(new TransformationTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> MINING_SAPLING = BLOCKS.register("mining_sapling", () -> new SaplingBlock(new MiningTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> SORTING_SAPLING = BLOCKS.register("sorting_sapling", () -> new SaplingBlock(new SortingTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> RAINBOW_OAK_SAPLING = BLOCKS.register("rainbow_oak_sapling", () -> new SaplingBlock(new RainboakTreeGrower(), BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));

	// TODO boats
	public static final RegistryObject<Block> TWILIGHT_OAK_PLANKS = BLOCKS.register("twilight_oak_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> CANOPY_PLANKS = BLOCKS.register("canopy_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<TrapDoorBlock> CANOPY_TRAPDOOR = BLOCKS.register("canopy_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(3.0F).sound(SoundType.WOOD).noOcclusion()));
	...
	public static final RegistryObject<Block> MANGROVE_PLANKS = BLOCKS.register("mangrove_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> DARK_PLANKS = BLOCKS.register("dark_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> TIME_PLANKS = BLOCKS.register("time_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> TRANSFORMATION_PLANKS = BLOCKS.register("transformation_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> MINING_PLANKS = BLOCKS.register("mining_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> SORTING_PLANKS = BLOCKS.register("sorting_planks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
